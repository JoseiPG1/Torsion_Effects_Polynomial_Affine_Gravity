...
Einstein's theory of General Relativity, it is a gravitational theory where the interactions is solely mediated by, the 
metric tensor \cite{Einstein_GR,Einstein_GR_Fundamentals,Einstein_GR_Bases}. Providing an ansatz compatible 
...
With the introduction of the cosmological constant (see Ref. \cite{Einstein_Cosmological_Constant}) it is possible to obtain non-trivial dynamics to 
describe the evolution of the universe, leading to nine different scenarios, depending on the values of the geomtrical factor $\kappa$ (which characterize
...
of the current state of the universe. In order to have a more accurate description of the observable universe,
...
its features, and how is possible to still have two different emergent-metrics structures despite being a purely affine model. A complete scan of cosmological
...
the last two terms are related to the torsion tensor, the former is the traceless torsion $\B{\alpha}{\beta}{\gamma}$ and the latter correspond to its
...
a sort of \textit{dimensional analysis} technique. The method allows us to consider every single possible configuration of scalar densities composed by powers
of all the irreducible fields of the affine connection \cite{castillofelisola2016einsteins,Castillo_Felisola_2020}. In the same spirit the three-dimensional model was also built up Ref. \cite{Castillo_Felisola_2022_EPJC}.
